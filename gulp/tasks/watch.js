...
gulp.task('watch', ['browserSync'], function() {
    ...
    gulp.watch(config.styles.src_files, ['pldoc_styles', 'demo_styles', 'styles']);
    gulp.watch(config.styles.pldoc_src_files, ['pldoc_styles']);
    gulp.watch(config.styles.demo_src_files, ['demo_styles']);
    ...
    gulp.watch(config.scripts.demo_src_files, ['demo_scripts']);
