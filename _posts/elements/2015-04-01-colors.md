...
info: These are the predefined colors used throughout our patterns and elements. Values here (noted in RGB, HEX, and the Sass variable) are used for backgrounds, text color, and decorative elements. Note - when using any values here, make sure that any text on a background passes WCAG AA guidelines for color contrast.
---
