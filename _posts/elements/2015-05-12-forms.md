    ...
    <form class="form">
        <fieldset class="form-group">
            ...
            <div class="field">
                ...
                <input class="field-input input-text" type="text" id="full_name_default" name="full_name_default" placeholder="e.g. Jane Doe">
            </div>
            <div class="field">
                <label class="field-label" for="email_address_default">Email address (default, disabled text field)</label>
                <input class="field-input input-text" type="email" id="email_address_default" name="email_address_default" placeholder="e.g. jane@email.com" disabled>
            </div>
            <div class="field">
            ...
            <div class="field">
                ...
                <input class="field-input input-text input-alt" type="text" id="full_name_simple" name="full_name_simple" placeholder="e.g. Jane Doe" required>
            </div>
            <div class="field">
    ...
    <form class="form">
        <fieldset class="form-group">
            ...
            <div class="field">
                ...
                <input class="field-input input-text" type="tel" id="tel_01" name="tel_01" placeholder="800-555-1515">
            </div>
        </fieldset>
    </form>
</div>
...
<div class="example-set">
    <form class="form">
        <fieldset class="form-group">
            ...
            <div class="field">
                <label class="field-label" for="select_01_suc">Choose your favorite color of the rainbow (default disabled select menu)</label>
                <select class="field-input input-select" id="select_01_suc" name="select_01_suc" disabled>
                    <option value="">- Choose one -</option>
                    <option value="Red">Red</option>
                    <option value="Orange">Orange</option>
                    <option value="Yellow">Yellow</option>
            ...
            <div class="field">
                <label class="field-label" for="select_02_suc">Choose your favorite color of the rainbow (enhanced select and disabled menu)</label>
                <select class="field-input input-select replace-select" id="select_02_suc" name="select_02_suc" disabled>
                    <option value="">- Choose one -</option>
                    <option value="Red">Red</option>
                    <option value="Orange">Orange</option>
                    <option value="Yellow">Yellow</option>
    ...
    <div class="form">
        <div class="form-group">
            <div class="field">
                ...
                <input type="range" class="input-slider" id="slider_01" name="slider_01" min="1" max="12" step="1" value="6" role="slider" aria-min="1" aria-max="12" aria-now="6">
            </div>
        </div>
    </form>
</div>
    ...
    <form class="form">
        ...
        <fieldset class="form-group">
            ...
            <div class="field">
                ...
                <input class="field-input input-text" type="email" id="email-address" name="email-address" placeholder="username@domain.com" required>
            </div>
            <div class="field">
                <label class="field-label field-required" for="phone-number">Phone number</label>
                <input class="field-input input-text" type="tel" id="phone-number" name="phone-number" placeholder="800-555-1515" required>
            </div>
            <div class="field">
