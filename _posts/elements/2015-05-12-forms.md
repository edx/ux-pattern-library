    ...
    <form class="form">
        <fieldset class="form-group">
            ...
            <div class="field">
                ...
                <input class="field-input input-text" type="email" id="email_address_default_helper" name="email_address_default_helper" placeholder="e.g. jane@email.com" aria-describedby="email_address_default_helper_text" required>
                <div class="field-hint" id="email_address_default_helper_text">
            ...
            <div class="field">
                ...
                <input class="field-input input-text has-success" type="email" id="email_address_default_suc_helper" name="email_address_default_suc_helper" placeholder="e.g. jane@email.com" value="jane@domain.com" aria-describedby="email_address_default_suc_helper_text" required>
                <div class="field-hint" id="email_address_default_suc_helper_text">
                    <p>Your email address will never be shared. We promise.</p>
                </div>
            </div>
            <div class="field">
