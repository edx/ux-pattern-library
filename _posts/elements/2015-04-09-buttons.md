...
<div class="example-set">
    <button type="button" class="btn btn-default btn-base has-icon">
        <svg class="icon icon-user"><use xlink:href="public/icons/edx-svg/svgdefs.svg#icon-user"></use></svg>
        Default Base with Icon
    </button>
    <button type="button" class="btn btn-default btn-base has-icon icon-reversed">
        <svg class="icon icon-user"><use xlink:href="public/icons/edx-svg/svgdefs.svg#icon-user"></use></svg>
        Default Base with Icon Reversed
    </button>
</div>
