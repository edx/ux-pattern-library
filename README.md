...
This will run the `default` gulp task defined in `gulpfile.js`, which has the following task dependencies: `['styles', pldoc_styles', 'images', 'pldoc_images', pldoc_scripts, jekyll-build' 'watch']`
